...
export function SpeakWithSpecialistCard({ item }: ItemCard) {
  ...
  return (
    <div className="flex flex-row items-start bg-skin-default rounded-lg py-4 px-6 mb-8 gap-6 max-tablet:px-4 max-tablet:gap-4">
      ...
      <div className="flex flex-col grow justify-start ">
        ...
        <Link
          href={""}
          className="hidden max-[1024px]:block font-roboto text-theme-primary-400 underline text-sm font-normal mt-1"
        >
