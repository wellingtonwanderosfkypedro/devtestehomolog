...
export const TitleBanner = ({ data }: TitleBannerProps) => {
  return (
    <div className="font-rajdhani flex flex-col items-center py-10 text-skin-primary max-laptop:px-6">
      ...
      <h1 className="font-semibold text-5xl  leading-[62px] max-w-[1170px] text-center mb-4 max-laptop:text-4xl max-[768px]:text-3xl max-[768px]:text-start text-[30px] tablet:text-[48px]">
        {data?.title}{" "}
        <span className="font-bold text-skin-text-orange">
