  ...
  return (
    <div className="bg-skin-default px-[30px] py-[20px] rounded-[4.24px] tablet:rounded-md tablet:px-[35px] laptop:max-w-[488px]">
      <div className="flex flex-col items-center my-[70px]">
        ...
        <h3 className="text-[16px] leading-[20px] text-skin-error pt-[20px] pb-[15px] tablet:pt-[25px] tablet:pb-[25px] font-roboto font-bold tablet:text-[24px] tablet:leading-[18px]">
