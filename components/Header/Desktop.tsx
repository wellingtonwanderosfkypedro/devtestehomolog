...
export const DesktopHeader = () => {
  ...
  return (
    <header
      className={` w-full mx-auto pt-4 px-2 min-[1100px]:px-4 font-rajdhani  fixed z-50 transition-all border-b-[1px] ${
        headerWhite
      ...
      <div className="maxDesktop:max-w-[1440px] min-[1120px]:w-11/12 mx-auto flex justify-between items-center pb-6 relative">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link
            ...
            className="flex bg-blue-500 text-base font-bold py-3 px-7 min-[1290px]:px-12 text-white text-nowrap"
          >
            Contato Comercial
          </Link>
        </div>
